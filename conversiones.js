...
//console.log(hsv2rgb(212, 0.94, 0.78431));
//console.log(rgbToHsv(12, 12, 12));
//console.log(rgbToHsl(160, 255, 50));
//console.log(rgbToCmy(80, 35, 98));
//console.log(hsl2rgb(88, 0.598, 1));
console.log(cmyToRgb(0.3529, 0.8039, 0.5294));
